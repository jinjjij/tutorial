...
class gameScene extends Phaser.Scene{
    constructor(){
        ...
        this.player;
        this.cursor;
        this.playerSpeed = speedDown * 1.2;
        this.target;
        this.points = 0;
        this.textScore;
        this.textTime;
    ...
    create(){
        ...
        this.player.setSize(this.player.width *3 / 4, this.player.height / 6)
            .setOffset(this.player.width / 8, this.player.height * 5 / 6 );
    ...
    update(){
        ...
        if(this.target.y >= sizes.height){
            this.target.setY(0);
            this.target.setX(this.getRandomX(480));
        }
    ...
    getRandomX (x_range) {
        return Math.floor(Math.random() * x_range);
    }
